...
#pragma mark pointer stream
            ...
            template <typename T>
            struct getter_functiodice_accum_pointer_stream : abstract_pointer_stream<T> {
                getter_functiodice_accum_pointer_stream(T (*getter)())
                : getter(getter) {};
...
#pragma mark factory
            ...
            std::shared_ptr<abstract_pointer_stream<T> > pointer_stream_factory(T (*g)()) {
                return std::shared_ptr<abstract_pointer_stream<T> >(new getter_functiodice_accum_pointer_stream<T>(g));
            }
